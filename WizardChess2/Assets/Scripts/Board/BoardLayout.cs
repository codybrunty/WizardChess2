...
public class BoardLayout : ScriptableObject
{
    ...
    {
        if (boardSquares.Length <= index) { Debug.LogError("Index of piece is out of range"); return new Vector2Int(-1, -1); }
    ...
    {
        if (boardSquares.Length <= index) { Debug.LogError("Index of piece is out of range"); return ""; }
    ...
    {
        if (boardSquares.Length <= index) { Debug.LogError("Index of piece is out of range"); return TeamColor.Blue; }
